...
> MWM HOUSE RULE: APKs build in GitHub Actions ONLY. Never run `./gradlew` builds on this box (8GB RAM, OOMs). This skill is for architecture/code patterns, not local builds. (Upstream: dpconde/claude-android-skill, MIT, vendored 2026-08-07.)
